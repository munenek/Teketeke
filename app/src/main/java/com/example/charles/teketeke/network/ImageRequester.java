package com.example.charles.teketeke.network;
...
import com.example.charles.teketeke.application.TeketekeApplication;
...
public class ImageRequester {
    ...
    private ImageRequester() {
        context = TeketekeApplication.getAppContext();
